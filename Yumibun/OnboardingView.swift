    ...
    private var bottomControls: some View {
        VStack(spacing: 22) {
            ...
            Button {
                ...
                Text(isLastPage ? "Use Yumibun" : "Continue")
